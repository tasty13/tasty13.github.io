...
(function () {
  ...
  function categoryCollapse() {
    ...
    collapse.on('hide.bs.collapse', function () {
      /* Bootstrap collapse events. */const parentId = parentPrefix + $(this).attr('id').substring(childPrefix.length);
      if (parentId) {
        $("#".concat(parentId, " .far.fa-folder-open")).attr('class', 'far fa-folder fa-fw');
        $("#".concat(parentId, " i.fas")).addClass('rotate');
        $("#".concat(parentId)).removeClass('hide-border-bottom');
      }
    });
    ...
    collapse.on('show.bs.collapse', function () {
      ...
      if (parentId) {
        $("#".concat(parentId, " .far.fa-folder")).attr('class', 'far fa-folder-open fa-fw');
        $("#".concat(parentId, " i.fas")).removeClass('rotate');
        $("#".concat(parentId)).addClass('hide-border-bottom');
      }
    });
  }
